...
function init() {
    ...
    // Listens for closing notifications
    document.querySelector("#notification a").addEventListener("click", closeNotification);
    ...
    document.querySelector("#tariff-overview .flexcontainer").addEventListener("click", handleTariffClick, true);
