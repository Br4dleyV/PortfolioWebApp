...
function calculateOptimalTariff(e){
    ...
    // Get estimated kwh
    estimatedElectricityKWh = calculateAverageElectricityConsumption(_data.peopleInHousehold);
    estimatedHeatKwH = calculateAverageHeatConsumption(_data.insulation, _data.propertytype, _data.peopleInHousehold);
    renderConsumptionEstimates(estimatedElectricityKWh, estimatedHeatKwH);
